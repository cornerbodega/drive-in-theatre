...
var _syncCheckResBody = {};
    ...
    function getQA(error, syncCheckRes, syncCheckResBody) {
        ...
        request(lcbPost({
            ...
            barcodeid: barcodes
        }), checkForInventoryToReceive);

        function checkForInventoryToReceive(error, qaRes, qaBody) {
